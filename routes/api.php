...
//Video Controller
Route::get('/video/view/{id}', [VideosController::class, 'get_url'])->name('video_url');
Route::get('/video/active', [VideosController::class, 'active_videos'])->name('all_active');
Route::get('/video/inactive', [VideosController::class, 'inactive_videos'])->name('all_inactive');

//get strean url
Route::get('/stream/view/{id}', [StreamsController::class, 'stream_url'])->name('stream_url');
