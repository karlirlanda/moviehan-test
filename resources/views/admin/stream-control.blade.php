    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="sidebar">
                <div class="sidebar-menu">
                    ...
                    <li class="item" id="settings">
                        <a href="{{route('stream-control')}}" class="menu-btn active">
            ...
            <div class="main-container">
                <div class="card">
                    <h1>Livestream Control Table</h1>
                </div>
                <div class="card">
                    <div class="table">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <form>
                                          ...
                                          <div class="mb-1">
                                            <label for="recipient-name" class="col-form-label">RTMP:</label>
                                            <input type="text" class="form-control" id="recipient-name">
                                          </div>
                                           <div class="mb-1">
                                            <label for="recipient-name" class="col-form-label">HASH:</label>
                                            <input type="text" class="form-control" id="recipient-name">
                                          </div>
                                           <div class="mb-1">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="info">Livestream 1</td>
                                <td class="info"> </td>
                                <td class="info">status</td>
                                <td  class="control-user">
                                    <button class="button view" type="submit">Enable</button>
